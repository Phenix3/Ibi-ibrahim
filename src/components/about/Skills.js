const programming = [
  { id: 1, name: "PHP / Symfony / Laravel", value: 95 },
  { id: 2, name: "JavaScript", value: 80 },
  { id: 3, name: "ReactJS", value: 75 },
];
const language = [
  { id: 1, name: "Francais", value: 90 },
        ...
        <div className="in w-full h-auto clear-both float-left flex">
          <div className="left w-1/2 pr-[50px]">
            <div className="tokyo_section_title w-full h-auto clear-both float-left mb-[40px]">
              <h3 className="text-[20px] font-bold">Compétences en programmation</h3>
            </div>
          ...
          <div className="right w-1/2 pl-[50px]">
            <div className="tokyo_section_title w-full h-auto clear-both float-left mb-[40px]">
              <h3 className="text-[20px] font-bold">Compétences linguistiques</h3>
            </div>
            <div className="tokyo_progress">
              {language.map((skill) => (
                <div className="progress_inner" key={skill.id}>
